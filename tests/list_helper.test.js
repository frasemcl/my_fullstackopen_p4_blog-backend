...
describe('total likes', () => {
  ...
  test('likes of a bigger list is calculated right', () => {
...
describe('top likes', () => {
  test('top liked blog post correctly returned', () => {
...
describe('most blog posts', () => {
  test('author name and number of posts is correct', () => {
...
describe('most liked author', () => {
  test('author name and total likes is correct', () => {
